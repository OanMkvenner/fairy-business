...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    public abstract class BoldLayoutGroup : UIBehaviour, ILayoutElement, ILayoutGroup
    {
        [Serializable]
        public struct PaddingFloats {
            [SerializeField, HideInInspector] private float m_padLeft, m_padRight, m_padTop, m_padBottom;
            public float left;
            public float right;
            public float top;
            public float bottom;
        ...
        [SerializeField] protected PaddingFloats m_Padding = new PaddingFloats();
        /// <summary>
        /// The padding to add around the child layout elements.
        /// </summary>
        public PaddingFloats padding { get { return m_Padding; } set { SetProperty(ref m_Padding, value); } }
        ...
        /// <summary>
        /// Mark the BoldLayoutGroup as dirty.
        /// </summary>
